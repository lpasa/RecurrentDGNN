...
if __name__ == '__main__':
    ...
    test_name = test_name + "_data-"+ dataset_name + "_aggregator-" + aggregator +  "_nFold-" + str(n_folds) + "_lr-" + str(lr) +"_drop_prob-"+str(drop_prob)+"_weight-decay-"+ str(weight_decay)+ "_batchSize-" + \
    ...
    for split_id, split in enumerate(dataset_cv_splits):
        ...
        model_impl.train_test_model(split_id, loader_train,  loader_test, loader_valid, n_epochs, test_epoch, aggregator,test_name, training_log_dir)
